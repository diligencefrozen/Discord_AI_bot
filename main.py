...
BAD_ROOTS = {
    ...
    "ㅅㅂ","ㅆㅂ","ㅇㅁ","ㄲㅈ","ㅄ","ㅂㅅ","닥치","씨벌","시벌","븅띤","치매","또라이",
    "도라이","피싸개","정신병","조선족","쪽발이","쪽빨이","쪽바리","쪽팔이",
    "아가리","ㅇㄱㄹ","fuck","좆","설거지","난교","재명","재앙","개놈","개년",
    "sex", "ㅗ", "아줌마", "노괴","보이루","ㅂㅇㄹ","개같", "개새", "개색", "개색기",
    "개수작", "개쓰레기", "개돼지","좆같", "좆까", "좆밥", "좆만", "좆먹", "엿먹", "염병", "염뱅",
    "시바", "시바알", "시벌탱", "씨방", "씨바", "씨바알", "씨부레", "씨부럴",
    "니미", "느금마", "느금애미", "ㄴㄱㅁ", "ㅇㅂ", "등신", "무뇌", "저능",
